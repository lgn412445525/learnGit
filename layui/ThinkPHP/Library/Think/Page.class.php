...
class Page
{
    ...
    private $config = array(
        'header' => '<li><span class="rows text-danger">共 %TOTAL_ROW% 条记录</span></li>',
        'prev'   => '<<',
        'next'   => '>>',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    public function show()
    {
        ...
        //上一页
        $up_row  = $this->nowPage - 1;
        $up_page = $up_row > 0 ? '<li><a href="' . $this->url($up_row) . '">' . $this->config['prev'] .
            '</a></li>' : '';
        ...
        $the_end = '';
        if ($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages) {
            $the_end = '<li><a href="' . $this->url($this->totalPages) . '">' . $this->config['last'] .
                '</a></li>';
        }
