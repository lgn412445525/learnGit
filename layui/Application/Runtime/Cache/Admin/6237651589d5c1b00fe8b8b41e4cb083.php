                        ...
                        <td>
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only del" href="javascript:if(confirm('确定删除？'))location='<?php echo U('Admin/Nav/delete',array('id'=>$v['id']));?>'"><span class="am-icon-trash-o"></span> 删除</a>
                                </div>
                            </div>
                        </td>
