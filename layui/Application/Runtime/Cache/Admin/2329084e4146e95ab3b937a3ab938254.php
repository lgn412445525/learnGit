...
<div class="am-cf admin-main">
    ...
    <!-- sidebar end -->
<link rel="stylesheet" href="/layui/Public/statics/webuploader-0.1.5/xb-webuploader.css">
<script src="/layui/Public/statics/js/jquery-1.10.2.min.js"></script>
<div class="form-group">
    <label>图集上传</label>
    <div id="upload-580ed6828a46f" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-580ed6828a46f .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-580ed6828a46f .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
        ...
        chunked: true,
        server: "<?php echo U('Admin/Banner/ajax_upload');?>",
        fileNumLimit: 300,
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-580ed6828a46f .filePicker2",
       label: '继续添加'
    });
    ...
    function addFile( file ) {
        var $li = $( '<li id="' + file.id + '">' +
                ...
                '<input class="bjy-filename" type="hidden" name="banner[]">'+
                '</li>' ),
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-580ed6828a46f .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-580ed6828a46f .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-580ed6828a46f .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
    ...
    <script>
    var BASE_URL = '/layui/Public/statics/webuploader-0.1.5';
</script>
